          ...
          <div className="sticky top-4 space-y-6">
            <Card className="border sticky top-4">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="w-full flex flex-row justify-top gap-2">
                  {connected ? (
                    <Button
                  ...
                  <Tooltip>
                    <TooltipTrigger className="p-[2px] w-4 h-4 border rounded-full text-[10px]">
                      !
                    </TooltipTrigger>
                    <TooltipContent>
                      <p className="text-[12px] self-start">
                        Support {project.name} by making a donation. Your
                        contribution will help the team continue their work and
                        achieve their goals.
                      </p>
                    </TooltipContent>
                  </Tooltip>
    ...
    >
      ...
      >
        ...
        <div className="flex gap-x-2">
          ...
          >
            {isLoading && (
              <span className="inline-block w-3 h-3 border-3 border-transparent border-t-neutral-700 border-l-neutral-700 animate-spin rounded-full"></span>
            )}
            <span>Donate Now</span>
          </Button>
          <Button
            onClick={() => setIsDonateModalOpen(false)}
            className="basis-[30%] cursor-pointer"
          >
            Close
          </Button>
        </div>
